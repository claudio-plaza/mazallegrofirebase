...
export const familiarBaseSchema = z.object({
  ...
  dni: z.string().regex(/^\d{7,8}$/, "DNI debe tener 7 u 8 dígitos numéricos."),
  fotoDniFrente: requiredFileField(dniFileSchemaConfig, "Se requiere foto del DNI (frente) del familiar."),
  fotoDniDorso: requiredFileField(dniFileSchemaConfig, "Se requiere foto del DNI (dorso) del familiar."),
  fotoPerfil: requiredFileField(profileFileSchemaConfig, "Se requiere foto de perfil del familiar."),
  fotoCarnet: optionalFileField(profileFileSchemaConfig),
