            ...
            <Separator />
             <section>
                ...
                {grupoFamiliarFields.map((field, index) => {
                    const fotoPerfilFamiliarValue = form.watch(`grupoFamiliar.${index}.fotoPerfil`);
                    const fotoPerfilFamiliarActual = useMemo(() => {
                        ...
                        return `https://placehold.co/64x64.png?text=${form.watch(`grupoFamiliar.${index}.nombre`)?.[0] || 'F'}${form.watch(`grupoFamiliar.${index}.apellido`)?.[0] || ''}`;
                    }, [fotoPerfilFamiliarValue, form.watch(`grupoFamiliar.${index}.nombre`), form.watch(`grupoFamiliar.${index}.apellido`)]);
